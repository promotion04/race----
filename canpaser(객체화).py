...
can_data = [
        ...
        "구조체": [
            {
                ...
                "데이터 필드": [
                    ...
                    {"name": "on_be1", "bit": 1},
                    {"name": "on_be2", "bit": 1},
                    {"name": "AMK_bSystemReady", "bit": 1},
                    {"name": "AMK_bWarn", "bit": 1},
                    {"name": "AMK_bSError", "bit": 1},
                    {"name": "AMK_bQuitDcOn", "bit": 1},
                    {"name": "AMK_bQuitInverterOn", "bit": 1}
                ]
            },
            {
                "구조체 이름": "inv2",
    ...
    },
    {
        ...
        "구조체": [
            {
                "구조체 이름": "power_limit_t",
                "데이터 필드": [
                    {"name": "pack_current", "bit": 16},
                    {"name": "pack_voltage", "bit": 16},
                    {"name": "pack_charge_current_limit", "bit": 16},
                    {"name": "pack_discharge_current_limit", "bit": 16}
                ]
            }
        ]
    },
    {
        "CAN ID": "0x10000",
        "메시지 이름": "BatteryDiagnose",
        "구조체": [
            {
                "구조체 이름": "battery_diagnose_t",
                "데이터 필드": [
                    {"name": "precharge_state_signal1", "bit": 8},
                    {"name": "precharge_state_signal2", "bit": 8},
                    {"name": "relay_contact_signal1", "bit": 8},
                    {"name": "relay_contact_signal2", "bit": 8},
                    {"name": "relay_contact_signal3", "bit": 8},
                    {"name": "tsal_signal", "bit": 8},
                    {"name": "IMD_status_frequency", "bit": 8},
                    {"name": "reserved", "bit": 8}
                ]
            }
        ]
        ...
        "구조체": [
            {
                "구조체 이름": "cooling_on_t",
                "데이터 필드": [
                    {"name": "manual_mode_on", "bit": 1},
                    {"name": "water_pump0_on", "bit": 1},
                    {"name": "water_pump1_on", "bit": 1},
                    {"name": "radiator0_on", "bit": 1},
                    {"name": "radiator1_on", "bit": 1},
                    {"name": "external_fan", "bit": 1},
                    {"name": "on_all", "bit": 1},
                    {"name": "rst", "bit": 1},
                    {"name": "reserved_0", "bit": 8},
                    {"name": "reserved_1", "bit": 16},
                    {"name": "reserved_2", "bit": 32}
                ]
            }
        ]
    },
    {
        "CAN ID": "0x20001",
        "메시지 이름": "FanStatusData",
        "구조체": [
            {
                "구조체 이름": "fan_status_data_t",
                "데이터 필드": [
                    {"name": "FanFlag", "bit": 8},
                    {"name": "TIM15_Dutycycle", "bit": 8},
                    {"name": "TIM15_Frequency", "bit": 8},
                    {"name": "TIM16_Dutycycle", "bit": 8},
                    {"name": "TIM16_Frequency", "bit": 8},
                    {"name": "TIM17_Dutycycle", "bit": 8},
                    {"name": "TIM17_Frequency", "bit": 8},
                    {"name": "desiredDuty", "bit": 8}
                ]
            }
        ]
    },
    {
        "CAN ID": "0x20002",
        "메시지 이름": "FanTargetDuty",
        "구조체": [
            {
                "구조체 이름": "fan_target_duty_t",
                "데이터 필드": [
                    {"name": "TargetDuty_SideIntake", "bit": 8},
                    {"name": "TargetDuty_SegmentIntake70", "bit": 8},
                    {"name": "TargetDuty_SegmentExhaust60", "bit": 8},
                    {"name": "TargetDuty_SegmentExhaust80", "bit": 8},
                    {"name": "reserved_0", "bit": 32}
                ]
            }
        ]
    },
    {
        "CAN ID": "0x30000",
        "메시지 이름": "BmsTempAndSoc",
        "구조체": [
            {
                "구조체 이름": "bms_temp_and_soc_t",
                "데이터 필드": [
                    {"name": "high_temp", "bit": 8},
                    {"name": "avg_temp", "bit": 8},
                    {"name": "bms_temp", "bit": 8},
                    {"name": "pack_soc", "bit": 8},
                    {"name": "dtc_status_1", "bit": 16},
                    {"name": "dtc_status_2", "bit": 8},
                    {"name": "reserved_0", "bit": 8}
                ]
            }
        ]
    },
    {
        ...
        "구조체": [
            {
                "구조체 이름": "bms_voltage_t",
                "데이터 필드": [
                    {"name": "low_cell_voltage", "bit": 16},
                    {"name": "high_cell_voltage", "bit": 16},
                    {"name": "low_open_cell_voltage", "bit": 16},
                    {"name": "high_open_cell_voltage", "bit": 16}
                ]
            }
        ]
    },
    {
        "CAN ID": "0x40101",
        "메시지 이름": "AmkSetpoint1_FR",
        "구조체": [
            {
                "구조체 이름": "amk_setpoint1_fr_t",
                "데이터 필드": [
                    {"name": "AMK_bReserve1", "bit": 8},
                    {"name": "AMK_bInverterOn", "bit": 1},
                    {"name": "AMK_bDcOn", "bit": 1},
                    {"name": "AMK_bEnable", "bit": 1},
                    {"name": "AMK_bErrorReset", "bit": 1},
                    {"name": "AMK_bReserve2", "bit": 4},
                    {"name": "AMK_Torque_setpoint", "bit": 16},
                    {"name": "AMK_TorqueLimitPositv", "bit": 16},
                    {"name": "AMK_TorqueLimitNegativ", "bit": 16}
                ]
            }
        ]
    },
    {
        "CAN ID": "0x40300",
        "메시지 이름": "SteeringAndPedal",
        "구조체": [
            {
                "구조체 이름": "steering_and_pedal_t",
                "데이터 필드": [
                    {"name": "steering_angel", "bit": 16},
                    {"name": "apps", "bit": 8},
                    {"name": "bpps", "bit": 8},
                    {"name": "brake_pressure", "bit": 16},
                    {"name": "reserved_0", "bit": 16}
                ]
            }
        ]
    },
        ...
        "구조체": [
            {
                "구조체 이름": "gear_temp_t",
                "데이터 필드": [
                    {"name": "gear_temp_fl", "bit": 16},
                    {"name": "gear_temp_fr", "bit": 16},
                    {"name": "gear_temp_rl", "bit": 16},
                    {"name": "gear_temp_rr", "bit": 16}
                ]
            }
        ]
    }
